    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <main className="w-full">
        ...
        <section className="relative flex min-h-screen w-full items-center justify-center overflow-hidden pt-20">
          ...
          >
            <motion.h1 variants={fadeInUp} className="mb-8 text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl md:text-6xl lg:text-7xl drop-shadow-sm">
              {t.hero.titleStart} <br className="hidden md:block" />
              <span className="text-[#2E447A]">
                {t.hero.titleEnd}
              </span>
            </motion.h1>

            <motion.p variants={fadeInUp} className="mb-10 max-w-2xl text-lg font-medium text-slate-700 sm:text-xl leading-relaxed">
              {t.hero.subtitle}
            </motion.p>
            ...
            <motion.div variants={fadeInUp} className="flex flex-col items-start justify-start gap-5 sm:flex-row">
              ...
              <Link
                href="#services"
                className="group w-full sm:w-auto bg-white/80 backdrop-blur-sm px-8 py-4 text-lg font-bold text-slate-800 shadow-lg ring-1 ring-slate-200 transition-all hover:bg-white hover:text-[#2E447A] hover:shadow-xl hover:-translate-y-1"
              >
                {t.hero.ourServices}
              </Link>
            </motion.div>
        ...
        <section id="about" className="relative flex min-h-screen w-full items-center justify-center bg-slate-50 pt-20 overflow-hidden">
          ...
          >
            <motion.h2 variants={fadeInUp} className="mb-6 text-3xl font-bold text-slate-900 sm:text-4xl md:text-5xl">
              {t.about.title}
            </motion.h2>
            <motion.p variants={fadeInUp} className="mx-auto max-w-4xl text-lg text-slate-600 leading-relaxed">
              {t.about.description}
            </motion.p>
            ...
            <motion.div variants={staggerContainer} className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-3">
              {t.about.items.map((item, idx) => (
                <motion.div 
                  ...
                  className="rounded-2xl bg-white p-8 shadow-xl border-t-4 border-[#2E447A]"
                >
                  <div className="mb-6 flex h-16 w-16 mx-auto items-center justify-center rounded-full bg-slate-100 text-[#2E447A]">
           ...
           >
            <div className="grid grid-cols-1 gap-12 items-center md:grid-cols-2">
              <div className="text-left">
                <motion.h2 variants={fadeInUp} className="mb-8 text-3xl font-bold text-slate-900 sm:text-4xl md:text-5xl leading-tight">
                  {t.targetAudience.titleStart} <br/>
                  <span className="text-[#2E447A]">{t.targetAudience.titleEnd}</span>
                </motion.h2>
                
                <ul className="space-y-6">
                  {t.targetAudience.list.map((item, idx) => (
                    <motion.li variants={fadeInUp} key={idx} className="flex items-center gap-4 p-4 rounded-xl hover:bg-slate-50 transition-colors">
              ...
              <motion.div variants={fadeInUp} className="relative h-[500px] w-full overflow-hidden rounded-2xl bg-slate-100 shadow-2xl border border-slate-200">
                <Image
                  src="/work.jpg"
                  alt="Target Audience"
                  fill
        ...
        {/* 4️⃣ SERVICES */}
        <section id="services" className="relative flex min-h-screen w-full items-center justify-center bg-slate-50 pt-20">
           <motion.div 
             initial="hidden"
             whileInView="visible"
             viewport={{ once: true }}
           ...
           >
            <motion.h2 variants={fadeInUp} className="mb-12 text-3xl font-bold text-slate-900 sm:text-4xl md:text-5xl">
              {t.services.title}
            </motion.h2>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {t.services.list.map((service, idx) => (
                <motion.div 
                  ...
                  className="group flex flex-col items-center justify-center rounded-xl bg-white p-6 shadow-md transition-all hover:shadow-xl border border-slate-100 cursor-pointer"
                >
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-slate-50 text-[#2E447A] group-hover:bg-[#2E447A] group-hover:text-white transition-colors">
                    <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <h3 className="text-center text-lg font-semibold text-slate-900 group-hover:text-[#2E447A] transition-colors">
                    {service}
                  </h3>
                </motion.div>
              ))}
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              {t.whyUs.items.map((item, idx) => (
                <motion.div 
                  ...
                  variants={fadeInUp}
                  whileHover={{ y: -5 }}
                  className="flex flex-col items-start rounded-xl bg-slate-50 p-8 shadow-sm transition-all hover:shadow-md border-l-4 border-[#2E447A] hover:border-l-8"
                >
        ...
        {/* 6️⃣ TEAM */}
        <section className="relative flex min-h-screen w-full items-center justify-center bg-slate-50 pt-20">
           <motion.div 
             initial="hidden"
             whileInView="visible"
             viewport={{ once: true }}
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              {t.team.members.map((member, idx) => (
                <motion.div 
                  ...
                  variants={fadeInUp}
                  whileHover={{ y: -10 }}
                  className="group relative flex flex-col items-center overflow-hidden rounded-xl bg-white p-8 shadow-sm transition-all hover:shadow-xl border border-slate-100"
                >
                  <div className="mb-6 h-32 w-32 relative overflow-hidden rounded-full border-4 border-slate-100 shadow-md">
                    <Image
                      src={teamImages[idx]}
                      alt={member.name}
                      fill
                  ...
                  <p className="mb-4 font-semibold text-[#2E447A]">
                    {member.role}
                  </p>
                  
                  <div className="w-full border-t border-slate-200 py-4">
                    <p className="mb-2 text-sm text-slate-600">
                      <span className="font-semibold text-slate-900">{t.team.specialization}</span> <br/>
                      {member.spec}
                    </p>
                  </div>
                </motion.div>
        ...
        <section className="relative w-full bg-slate-50 py-20 overflow-hidden">
           ...
           >
            <div className="text-center mb-16">
              <motion.h2 variants={fadeInUp} className="text-3xl font-bold text-slate-900 sm:text-4xl md:text-5xl mb-6">
                {t.geography.title}
              </motion.h2>
              <motion.p variants={fadeInUp} className="max-w-2xl mx-auto text-lg text-slate-600">
                {t.geography.desc}
              </motion.p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {/* Astana Card */}
              <motion.div variants={fadeInUp} className="group relative overflow-hidden rounded-2xl bg-white shadow-xl border border-slate-100 transition-all hover:shadow-2xl hover:-translate-y-1">
                 <div className="h-1.5 bg-[#2E447A]"></div>
                 <div className="p-8">
                    <div className="flex items-center justify-between mb-6">
                       <h3 className="text-2xl font-bold text-slate-900">{t.geography.astana.city}</h3>
                       <div className="p-3 bg-blue-50 rounded-lg text-[#2E447A]">
                    ...
                    <div className="space-y-4 pt-6 border-t border-slate-100">
                       <div className="flex items-start gap-3">
                          ...
                          <span className="text-slate-700 text-sm">{t.geography.astana.address}</span>
                       </div>
                       <div className="flex items-start gap-3">
                          <svg className="w-5 h-5 text-[#2E447A] mt-1 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                          <div className="flex flex-col text-sm">
                             <a href="tel:+77001466646" className="text-slate-700 hover:text-[#2E447A] transition-colors">+7 700 146 66 46</a>
                             <a href="tel:+77001466601" className="text-slate-700 hover:text-[#2E447A] transition-colors">+7 700 146 66 01</a>
                          </div>
                       </div>
                    </div>
                 </div>
              ...
              <motion.div variants={fadeInUp} className="group relative overflow-hidden rounded-2xl bg-white shadow-xl border border-slate-100 transition-all hover:shadow-2xl hover:-translate-y-1">
                 ...
                 <div className="p-8">
                    <div className="flex items-center justify-between mb-6">
                       <h3 className="text-2xl font-bold text-slate-900">{t.geography.almaty.city}</h3>
                    ...
                    <div className="space-y-4 pt-6 border-t border-slate-100">
                       <div className="flex items-start gap-3">
                          ...
                          <span className="text-slate-700 text-sm">{t.geography.almaty.address}</span>
                       </div>
                       <div className="flex items-start gap-3">
                          <svg className="w-5 h-5 text-blue-600 mt-1 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                          <div className="flex flex-col text-sm">
                             <a href="tel:+77780008872" className="text-slate-700 hover:text-blue-600 transition-colors">+7 778 000 88 72</a>
                          </div>
                       </div>
                    </div>
                 </div>
        ...
        {/* 8️⃣ HOW WE WORK */}
        <section className="relative flex w-full items-center justify-center bg-slate-50 py-16 sm:py-20">
           <motion.div 
             initial="hidden"
             whileInView="visible"
             viewport={{ once: true }}
             ...
             className="w-full max-w-7xl px-4 text-center sm:px-6 lg:px-8"
           >
            <motion.h2 variants={fadeInUp} className="mb-16 text-3xl font-bold text-slate-900 sm:text-4xl md:text-5xl">
              {t.process.title}
            </motion.h2>
            ...
            <div className="relative flex flex-col justify-between gap-8 md:flex-row">
              ...
              {t.process.steps.map((item, idx) => (
                <motion.div key={idx} variants={fadeInUp} className="group relative z-10 flex flex-1 flex-col items-center">
                  <div className="mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-white shadow-lg transition-all group-hover:scale-110 group-hover:bg-[#2E447A] group-hover:text-white border-4 border-slate-50 z-20">
        ...
        <section className="relative flex min-h-screen w-full items-center justify-center bg-white pt-20">
           ...
           >
            <motion.h2 variants={fadeInUp} className="mb-12 text-center text-3xl font-bold text-slate-900 sm:text-4xl md:text-5xl">
              {t.faq.title}
            </motion.h2>
            ...
            <div className="space-y-4">
              {t.faq.items.map((item, idx) => (
                <motion.details 
                  key={idx} 
                  variants={fadeInUp}
                  className="group rounded-xl bg-slate-50 shadow-sm border border-slate-100"
                >
                  <summary className="flex cursor-pointer items-center justify-between p-6 font-medium text-slate-900">
                    <span className="text-lg font-semibold">{item.q}</span>
                    <span className="ml-4 flex h-8 w-8 items-center justify-center rounded-full bg-slate-200 text-[#2E447A] transition-transform group-open:rotate-180">
                      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  >
                    {!isSuccess ? (
                      <form onSubmit={handleSubmit} className="space-y-6">
                        <h3 className="text-2xl font-bold text-slate-900 mb-2">{t.cta.form.title}</h3>
                        <p className="text-slate-500 text-sm mb-6">{t.cta.form.subtitle}</p>
                        
                        <div>
                          <label htmlFor="name" className="block text-sm font-medium text-slate-700 mb-2">{t.cta.form.nameLabel}</label>
                          <input 
                            type="text" 
                            id="name"
                            required
                            className="w-full px-4 py-3 rounded-xl bg-slate-50 border-transparent focus:border-[#2E447A] focus:bg-white focus:ring-0 text-slate-900 transition-all"
                        ...
                        <div>
                          <label htmlFor="phone" className="block text-sm font-medium text-slate-700 mb-2">{t.cta.form.phoneLabel}</label>
                          <input 
                            type="tel" 
                            id="phone"
                            required
                      ...
                      <div className="flex flex-col items-center justify-center py-12 text-center">
                        ...
                        <h3 className="text-2xl font-bold text-slate-900 mb-2">{t.cta.form.successTitle}</h3>
